...
#include <memory>
#include "../sdvp_qtcommon/legacy/packet.h"
...
QT_MOC_LITERAL(5, 36, 14), // "packetReceived"
QT_MOC_LITERAL(6, 51, 6), // "packet"
QT_MOC_LITERAL(7, 58, 11), // "processData"
QT_MOC_LITERAL(8, 70, 9) // "timerSlot"

    },
    "Packet\0dataToSend\0\0QByteArray&\0data\0"
    "packetReceived\0packet\0processData\0"
    "timerSlot"
};
...
// SIGNAL 1
void Packet::packetReceived(QByteArray & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
